...
def evaluate(args, model, tokenizer, eval_dataset, fileobject, start_pos=0, end_pos=5, vis=-1):
...
parser.add_argument("--model_name_or_path", default='./output/IMDB/pytorch_model.bin', type=str,
...
## Other parameters
parser.add_argument("--config_name", default="./output/IMDB/config.json", type=str,
                    help="Pretrained config name or path if not the same as model_name")
parser.add_argument("--tokenizer_name", default="./output/IMDB/added_tokens.json", type=str,
...
parser.add_argument('--end_pos', default=5, type=int, help='end position in the dataset')
