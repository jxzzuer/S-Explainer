...
## Required parameters
parser.add_argument("--data_dir", default='./dataset/hotel', type=str,
                    help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
parser.add_argument("--model_type", default='bert', type=str,
                    help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
parser.add_argument("--model_name_or_path", default='./output/hotel/pytorch_model.bin', type=str,
                    help="Path to pre-trained model or shortcut name selected in the list: ")
parser.add_argument("--task_name", default='SST-2', type=str,
                    help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
parser.add_argument("--output_dir", default='./output/hotel', type=str,
                    help="The output directory where the model predictions and checkpoints will be written.")
parser.add_argument("--save", default="", type=str,
                    help="Path to save the trained model.")

## Other parameters
parser.add_argument("--config_name", default="./output/hotel/config.json", type=str,
                    help="Pretrained config name or path if not the same as model_name")
parser.add_argument("--tokenizer_name", default="./output/hotel/added_tokens.json", type=str,
