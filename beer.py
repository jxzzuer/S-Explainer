...
# This is the processing file for the beer dataset, used for CooperativeGame where player1 and player2 are applied
# in filtering out positive and negative samples based on label thresholds.
...
#Step 1: Reading the JSON File,Step 2: Processing Annotations,Step 3: Creating Pytorch Datasets
...
#                 player2 = labels[1]
#
#                 if player1 <= self.neg_thres:
#                     label = 0
#                 elif player2 >= self.pos_thres:
#                     label = 1
#                 else:
#                     continue
#                 examples.append({'text': text, "label": label})
